...
//
// Todavía no está cableado: los marcadores actuales del mapa (mapMarkerIcons.js)
// ya usan categoryIconSvg directamente sobre sus propias carcasas (pastilla de
// precio y gota). Para adoptar esta variante, sustituir el icono del marcador
// por categoryPin(task.category) en el componente de mapa. Estilos globales en
// src/styles.css (.category-pin__bubble / __stem).
