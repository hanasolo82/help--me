-- Public helper discovery exposes a derived Stripe readiness signal only.
-- It never exposes account identifiers, payout details, or verification data.
